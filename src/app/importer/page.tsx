...
export default function ImporterOverviewPage() {
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      {/* 6 KPI Metric Cards matching Exporter/Admin aesthetic with ScrollReveal & AnimatedCounter */}
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        {/* Metric 1: Active RFQs */}
        <ScrollReveal delayMs={0} direction="up" className="h-full">
          <div className="rounded-xl border border-[#b9aa95] bg-[#e4dac9] p-4 shadow-sm space-y-1 hover:border-[#202522] transition-colors h-full flex flex-col justify-between">
            <div>
              ...
              <div className="text-2xl font-serif font-bold text-[#202522] mt-1">
                <AnimatedCounter
                  end={telemetry?.active_rfqs_count ?? 0}
                  duration={1200}
                />
              </div>
            </div>
            <div className="flex items-center gap-1 text-[10px] text-[#2d7a58] font-bold pt-2 border-t border-[#b9aa95]/40 mt-2">
        ...
        <ScrollReveal delayMs={60} direction="up" className="h-full">
          <div className="rounded-xl border border-[#b9aa95] bg-[#e4dac9] p-4 shadow-sm space-y-1 hover:border-[#202522] transition-colors h-full flex flex-col justify-between">
            <div>
              ...
              <div className="text-2xl font-serif font-bold text-[#202522] mt-1">
                <AnimatedCounter
                  end={telemetry?.sealed_quotes_received ?? 0}
                  duration={1300}
                />
              </div>
            </div>
            <div className="text-[10px] text-[#70695f] font-mono pt-2 border-t border-[#b9aa95]/40 mt-2">
        ...
        <ScrollReveal delayMs={120} direction="up" className="h-full">
          <div className="rounded-xl border border-[#b9aa95] bg-[#e4dac9] p-4 shadow-sm space-y-1 hover:border-[#202522] transition-colors h-full flex flex-col justify-between">
            <div>
              ...
              <div className="text-2xl font-serif font-bold text-[#202522] mt-1">
                <AnimatedCounter
                  end={telemetry?.evaluated_packhouses ?? 0}
                  duration={1400}
                />
              </div>
            </div>
            <div className="text-[10px] text-[#2d7a58] font-bold pt-2 border-t border-[#b9aa95]/40 mt-2">
        ...
        <ScrollReveal delayMs={180} direction="up" className="h-full">
          <div className="rounded-xl border border-[#b9aa95] bg-[#e4dac9] p-4 shadow-sm space-y-1 hover:border-[#202522] transition-colors h-full flex flex-col justify-between">
            <div>
              ...
              <div className="text-2xl font-serif font-bold text-[#202522] mt-1 flex items-baseline gap-1">
                <AnimatedCounter
                  end={telemetry?.contracted_volume_mt ?? 0}
                  separator=","
                  duration={1500}
                />
                <span className="text-xs font-normal font-sans text-[#70695f]">MT</span>
              </div>
            </div>
            <div className="text-[10px] text-[#70695f] font-mono pt-2 border-t border-[#b9aa95]/40 mt-2 truncate">
              Citrus, Onions & Herbs
            </div>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delayMs={240} direction="up" className="h-full">
          <div className="rounded-xl border border-[#b9aa95] bg-[#e4dac9] p-4 shadow-sm space-y-1 hover:border-[#202522] transition-colors h-full flex flex-col justify-between">
            <div>
              ...
              <div className="text-2xl font-serif font-bold text-[#202522] mt-1 flex items-baseline gap-1">
                <AnimatedCounter
                  end={telemetry?.avg_bid_response_hours ?? 0}
                  decimals={1}
                  duration={1200}
                />
                <span className="text-xs font-normal font-sans text-[#70695f]">hrs</span>
              </div>
            </div>
            <div className="text-[10px] text-[#2d7a58] font-bold pt-2 border-t border-[#b9aa95]/40 mt-2 truncate">
              High responsiveness
            </div>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delayMs={300} direction="up" className="h-full">
          <div className="rounded-xl border border-[#b9aa95] bg-[#e4dac9] p-4 shadow-sm space-y-1 hover:border-[#202522] transition-colors h-full flex flex-col justify-between">
            <div>
              ...
              <div className="text-2xl font-serif font-bold text-[#202522] mt-1">
                <AnimatedCounter
                  end={telemetry?.active_reefer_shipments ?? 0}
                  duration={1400}
                />
              </div>
            </div>
      ...
      {!loading && activeTab === 'rfqs' && (
        <div className="space-y-4">
          <ScrollReveal delayMs={80} direction="up">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-[#e4dac9] border border-[#b9aa95] p-3.5 rounded-lg shadow-xs">
              ...
              <Link
                href="/importer/new-rfq"
                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#9b452f] text-white text-xs font-bold uppercase tracking-wider rounded-sm hover:bg-[#833824] transition-colors shrink-0 shadow-sm"
              >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                    ...
                    <div className="md:col-span-3 flex flex-col sm:items-end justify-center gap-2">
                      ...
                      <button
                        ...
                        className="px-3.5 py-2 bg-[#202522] hover:bg-[#9b452f] text-white text-xs font-bold uppercase tracking-wider rounded transition-colors flex items-center gap-1.5 shadow-xs"
                      >
      ...
      {!loading && activeTab === 'quotes' && (
        <div className="space-y-4">
          <ScrollReveal delayMs={80} direction="up">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-[#e4dac9] border border-[#b9aa95] p-3.5 rounded-lg shadow-xs">
              <div className="text-xs text-[#202522] font-medium">
                {language === 'ar'
              ...
              <span className="text-xs font-mono font-bold text-[#596348] bg-[#596348]/10 px-2.5 py-1 rounded">
                <AnimatedCounter end={quotes.length} /> LIVE BIDS UNLOCKED
              </span>
            </div>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {quotes.map((q, idx) => (
              <ScrollReveal key={q.id} delayMs={idx * 80} direction="up">
                <div className="bg-[#e4dac9] border border-[#b9aa95] rounded-xl p-5 flex flex-col justify-between hover:border-[#202522] transition-all shadow-sm space-y-4 relative h-full">
                  ...
                  <div className="space-y-3">
                    ...
                    {/* Price Banner with AnimatedCounter */}
                    <div className="p-3 bg-[#eee8dc] border border-[#b9aa95] rounded-lg">
                      <div className="flex items-baseline justify-between">
                        <span className="text-2xl font-serif font-bold text-[#202522]">
                          $<AnimatedCounter end={q.price_per_mt_usd} separator="," duration={1200} />
                        </span>
                  ...
                  <div className="pt-3 border-t border-[#b9aa95]/60 flex items-center gap-2">
                    <button
                      ...
                      className="flex-1 py-2 bg-[#202522] hover:bg-[#9b452f] text-white text-xs font-bold uppercase tracking-wider rounded transition-colors text-center shadow-xs"
                    >
                    ...
                    <button
                      ...
                      className="px-3 py-2 bg-[#596348] hover:bg-[#48503a] text-white text-xs font-bold uppercase tracking-wider rounded transition-colors shadow-xs"
        ...
        <div className="space-y-4">
          <ScrollReveal delayMs={80} direction="up">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-[#e4dac9] border border-[#b9aa95] p-3.5 rounded-lg shadow-xs">
              ...
              <span className="text-xs font-mono font-bold text-[#596348] bg-[#596348]/10 px-2.5 py-1 rounded">
                <AnimatedCounter end={packhouses.length} /> VERIFIED PACKHOUSES
              </span>
            </div>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {packhouses.map((pack, idx) => (
              <ScrollReveal key={pack.id} delayMs={idx * 80} direction="up">
                <div className="bg-[#e4dac9] border border-[#b9aa95] rounded-xl p-5 flex flex-col justify-between hover:border-[#202522] transition-all shadow-sm space-y-4 h-full">
                  <div className="space-y-3">
                    ...
                    {/* Packhouse Specs with AnimatedCounter */}
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      <div className="p-2.5 bg-[#eee8dc] border border-[#b9aa95] rounded">
                        ...
                        <span className="font-serif font-bold text-[#202522] text-sm">
                          <AnimatedCounter end={pack.annual_capacity_mt} separator="," duration={1300} /> MT
                        </span>
                      </div>
                      <div className="p-2.5 bg-[#eee8dc] border border-[#b9aa95] rounded">
                        <span className="text-[10px] text-[#70695f] uppercase block">Cold Storage</span>
                        <span className="font-serif font-bold text-[#202522] text-sm">
                          <AnimatedCounter end={pack.cold_storage_capacity_mt} separator="," duration={1300} /> MT
                        </span>
                      </div>
                    </div>
        ...
        <div className="space-y-4">
          <ScrollReveal delayMs={80} direction="up">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-[#e4dac9] border border-[#b9aa95] p-3.5 rounded-lg shadow-xs">
              ...
              <span className="text-xs font-mono font-bold text-[#596348] bg-[#596348]/10 px-2.5 py-1 rounded">
                <AnimatedCounter end={shipments.length} /> ACTIVE VOYAGES
              </span>
            </div>
          </ScrollReveal>
          ...
          <div className="space-y-4">
            {shipments.map((ship, idx) => (
              <ScrollReveal key={ship.id} delayMs={idx * 80} direction="up">
                <div className="bg-[#e4dac9] border border-[#b9aa95] rounded-xl p-5 space-y-4 shadow-sm hover:border-[#202522] transition-colors">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#b9aa95]/60 pb-3">
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-[#596348] text-white text-[10px] font-bold uppercase font-mono">
                        ...
                        Steady at <AnimatedCounter end={ship.set_temperature_c} decimals={1} />°C
                      </span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-xs">
                    <div>
                      ...
                      <div className="text-[#70695f] font-mono text-[10px] mt-0.5">
                        Net Weight: <AnimatedCounter end={ship.quantity_mt} /> MT
                      </div>
                    </div>
                  ...
                  <div className="pt-3 border-t border-[#b9aa95]/60 flex flex-wrap items-center justify-between gap-3 text-xs">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-[#eee8dc] border border-[#b9aa95] hover:border-[#202522] text-[#202522] text-xs font-bold uppercase tracking-wider rounded transition-colors shadow-xs"
                    >
      ...
      {activeTab === 'compliance' && (
        <div className="space-y-6">
          <ScrollReveal delayMs={100} direction="up">
            <div className="bg-[#e4dac9] border border-[#b9aa95] rounded-xl p-6 space-y-4 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
                <ScrollReveal delayMs={150} direction="up">
                  <div className="p-4 bg-[#eee8dc] border border-[#b9aa95] rounded-lg space-y-2 h-full">
                ...
                <ScrollReveal delayMs={220} direction="up">
                  <div className="p-4 bg-[#eee8dc] border border-[#b9aa95] rounded-lg space-y-2 h-full">
                    <div className="flex items-center gap-2 text-[#596348] font-bold text-xs">
                ...
                <ScrollReveal delayMs={290} direction="up">
                  <div className="p-4 bg-[#eee8dc] border border-[#b9aa95] rounded-lg space-y-2 h-full">
                    <div className="flex items-center gap-2 text-[#596348] font-bold text-xs">
          ...
          <div className="bg-[#e4dac9] border border-[#b9aa95] rounded-2xl max-w-lg w-full p-6 space-y-6 shadow-2xl">
            ...
            <div className="p-4 bg-[#eee8dc] border border-[#b9aa95] rounded-xl space-y-3">
              <div className="flex items-baseline justify-between border-b border-[#b9aa95]/40 pb-2">
                ...
                <span className="text-2xl font-serif font-bold text-[#202522]">
                  $<AnimatedCounter end={selectedQuote.price_per_mt_usd} separator="," /> / MT
                </span>
              </div>
