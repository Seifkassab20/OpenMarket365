    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="space-y-4">
        {shipments.map((ship, idx) => (
          <ScrollReveal key={ship.id} delayMs={idx * 70} direction="up">
            <div
              className="bg-[#e4dac9] border border-[#b9aa95] rounded-xl p-5 space-y-4 shadow-sm hover:border-[#202522] transition-colors"
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#b9aa95]/60 pb-3">
                ...
                <div className="flex items-center gap-2">
                  <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-[#596348] text-white text-[10px] font-bold uppercase font-mono">
                    ...
                    Steady at <AnimatedCounter end={ship.set_temperature_c} decimals={1} duration={1000} />°C
                  </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-xs">
                <div>
                  ...
                  <div className="text-[#70695f] font-mono text-[10px] mt-0.5">
                    Payload: <AnimatedCounter end={ship.quantity_mt} duration={900} /> MT
                  </div>
                </div>
