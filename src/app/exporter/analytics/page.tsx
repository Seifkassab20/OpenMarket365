  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Profile Views */}
        <div className="bg-[#e4dac9] border border-[#b9aa95] rounded-2xl p-5 shadow-sm space-y-3">
        ...
        <div className="bg-[#e4dac9] border border-[#b9aa95] rounded-2xl p-5 shadow-sm space-y-3">
          ...
          <div className="space-y-1">
            <div className="text-3xl font-mono font-bold text-[#202522]">
              {analytics.search_impressions.toLocaleString()}
            </div>
            <div className="flex items-center gap-1 text-[11px] font-mono font-bold text-[#2d7a58]">
              <TrendingUp className="w-3.5 h-3.5" />
              <span>+{analytics.search_impressions_growth}% MoM</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#e4dac9] border border-[#b9aa95] rounded-2xl p-5 shadow-sm space-y-3">
          ...
          <div className="space-y-1">
            <div className="text-3xl font-mono font-bold text-[#202522]">
              {analytics.active_products_count}
            </div>
        ...
        <div className="bg-[#e4dac9] border border-[#b9aa95] rounded-2xl p-5 shadow-sm space-y-3">
          ...
          <div className="space-y-1">
            <div className="text-3xl font-mono font-bold text-[#202522]">
              {analytics.verified_certificates_count}
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[#e4dac9] border border-[#b9aa95] rounded-2xl p-6 shadow-sm space-y-6">
