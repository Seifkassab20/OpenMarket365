    ...
    <div className="min-h-[80vh] flex items-center justify-center p-6 bg-[#eee8dc]">
      <div className="max-w-md w-full bg-[#e4dac9] border border-[#b9aa95] rounded-2xl p-8 text-center space-y-6 shadow-sm">
        ...
        <div className="space-y-2">
          ...
          <h2 className="text-2xl font-serif text-[#202522]">Administrator Clearance Required</h2>
          <p className="text-xs text-[#70695f] leading-relaxed">
            The requested console is strictly reserved for authorized platform administrators and governance auditors. Your current account role is <span className="font-mono text-[#9b452f] font-bold">{currentUser?.role || 'UNAUTHENTICATED'}</span>.
          </p>
        </div>
        ...
        <div className="pt-2 space-y-3">
          ...
          >
            ...
            <span>SWITCH TO ADMIN ACCOUNT (DR. HESHAM)</span>
          </button>
